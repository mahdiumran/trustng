...
<p>
<h3>Live DNS Stats<br><small>'.$ipaddr.'</small></h3>
<div id="stats" title="Unbound Stats" align="center">';
include 's.php';
echo '</div>
<div align=center>
<button class="submit-button" onclick="stats()">Refresh</button> <a href="/"> <input type="button" class="submit-button" value="Kembali"></a>
