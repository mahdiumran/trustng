...
function trustng_menu_items()
{
    $items = array(
        ...
        array('setblack.php',    'Blacklist',   'fa-ban',                   'setblack.php'),
        array('setwhite.php',    'Whitelist',   'fa-shield-halved',         'setwhite.php'),
        ...
        array('activity.php',    'Activity',    'fa-clock-rotate-left',      'activity.php'),
        array('digtest.php',     'Digtest',     'fa-magnifying-glass-chart','digtest.php'),
        array('setpwd.php',      'Administration', 'fa-gears',              'setpwd.php'),

        array('maintenance.php', 'Maintenance', 'fa-screwdriver-wrench',    'maintenance.php'),
        array('resetstats.php',  'Reset Stats', 'fa-eraser',                'resetstats.php'),
    );
...
function trustng_render_sidebar($active = '')
{
    ...
    echo '<div class="sidebar-header">
        ...
        <button type="button" id="tng-theme-toggle" title="Ubah Tema (Terang/Gelap)" aria-label="Toggle theme">
    ...
    $groups = array(
        ...
        'Konfigurasi' => array('options.php', 'dbtrust.php', 'setblack.php', 'setwhite.php'),
        'Monitor'     => array('munin', 'stats.php', 'activity.php', 'digtest.php', 'temp.php'),
        'Sistem'      => array('setpwd.php', 'maintenance.php', 'resetstats.php'),
    );
    ...
    echo '<div class="sidebar-footer">
        <a href="logout.php" class="sidebar-logout" title="Logout" aria-label="Logout">
