...
if ($_GET['default'] == 'yes') {
    ...
    $lp2 = '103.173.75.28';
    $lp3 = '103.155.197.107';
    $lp4 = '2406:20c0::103:151:222:227';
    $lp5 = '2001:df4:b100:3:1:1:ee9b:2694';
    $lp6 = '2001:df7:c180:1470:87:173:230:24';
} else {
...
IPv4
<input type="text" name="lp1" class="form__w" value="'.$lp1.'"placeholder="103.181.142.196 (ip4-1)" required />
<input type="text" name="lp2" class="form__w" value="'.$lp2.'" placeholder="103.173.75.28 (ip4-2)" />
<input type="text" name="lp3" class="form__w" value="'.$lp3.'" placeholder="103.155.197.107 (ip4-3)" />';
if ($useip6 == 'yes') { echo '
IPv6
<input type="text" name="lp4" class="form__w" value="'.$lp4.'"placeholder="2406:20c0::103:151:222:227" required />
<input type="text" name="lp5" class="form__w" value="'.$lp5.'" placeholder="2001:df4:b100:3:1:1:ee9b:2694" />
<input type="text" name="lp6" class="form__w" value="'.$lp6.'" placeholder="2001:df7:c180:1470:87:173:230:24" />';
}
echo '
