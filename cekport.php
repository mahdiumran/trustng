...
<title>DNS TRUST-NG - CEK PORT</title>
...
trustng_render_sidebar('cekport.php');

echo '<div class="page-content">';
echo '<div class="tng-topbar"><button class="tng-topbar-toggle" title="Toggle menu" aria-label="Toggle menu"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="2" y="4.5" width="16" height="2" rx="1" fill="currentColor"/><rect x="2" y="9" width="16" height="2" rx="1" fill="currentColor"/><rect x="2" y="13.5" width="16" height="2" rx="1" fill="currentColor"/></svg></button><span class="tng-topbar-title">Cek Port</span><div class="tng-topbar-spacer"></div><a class="tng-topbar-back" href="/">&#8592; Dashboard</a></div>';
echo '
<div align=center>
<a href="/"><img src="img/logo-img/trust-ng.jpg" width="200px"></a>
<p>
<h3>Cek Port<br><small>'.$ipaddr.'</small></h3>
</div><div id="cekport" title="Cek Port" align="center">';
include 'c.php';
echo '</div>
<div align=center>
<button class="submit-button" onclick="cekport()">Refresh</button> <a href="/"> <input type="button" class="submit-button" value="Kembali"></a>
